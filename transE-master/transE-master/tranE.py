    ...
    def transE(self, cI = 20):
        ...
        for cycleIndex in range(cI):
            ...
            if cycleIndex % 100 == 0:
                ...
                print(self.loss)
                self.writeRelationVector("D:\\transE-master\\transE-master\\relationVector.txt")
                self.writeEntilyVector("D:\\transE-master\\transE-master\\entityVector.txt")
                self.loss = 0
...
if __name__ == '__main__':
    dirEntity = "D:\\transE-master\\transE-master\\FB15k\\entity2id.txt"
    entityIdNum, entityList = openDetailsAndId(dirEntity)
    dirRelation = "D:\\transE-master\\transE-master\\FB15k\\relation2id.txt"
    relationIdNum, relationList = openDetailsAndId(dirRelation)
    dirTrain = "D:\\transE-master\\transE-master\\FB15k\\train.txt"
    ...
    transE.initialize()
    transE.transE(15000)
    transE.writeRelationVector("D:\\transE-master\\transE-master\\relationVector.txt")
    transE.writeEntilyVector("D:\\transE-master\\transE-master\\entityVector.txt")
